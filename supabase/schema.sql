...
CREATE INDEX IF NOT EXISTS idx_recs_creator ON product_recommendations(creator_id);
...
CREATE TABLE IF NOT EXISTS decks (
  id                        TEXT PRIMARY KEY,
  creator_id                TEXT NOT NULL REFERENCES creators(id) ON DELETE CASCADE,
  product_recommendation_id TEXT REFERENCES product_recommendations(id),
  title                     TEXT,
...
CREATE INDEX IF NOT EXISTS idx_outreach_creator ON outreach_messages(creator_id);
...
CREATE TABLE IF NOT EXISTS threads (
  id                  TEXT PRIMARY KEY,
  creator_id          TEXT NOT NULL REFERENCES creators(id),
  outreach_message_id TEXT REFERENCES outreach_messages(id),
